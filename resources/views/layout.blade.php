...
<body class="home blog halimthemes halimmovies" data-masonry="">
        ...
        <div class="container">
            <div class="row" id="headwrap">
                        ...
                        <div class="col-xs-12">
                            ...
                            {{-- <form id="search-form-pc" name="halimForm" role="search" action="" method="GET">
                                <div class="form-group">
                                    <div class="input-group col-xs-12">
                                        <form action="{{ route('tim-kiem') }}" method="GET">
                                            <input id="timkiem" type="text" name="s" class="form-control"
                ...
                <div class="col-md-4 hidden-xs">
                    <div id="get-bookmark" class="box-shadow"><i class="hl-bookmark">
                        </i>
                        <span>
                            Home
                        </span>
                ...
                <div class="collapse navbar-collapse" id="halim">
                    <div class="menu-menu_1-container">
                        <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                            ...
                            @foreach ($category->take(10) as $key => $cate)
                ...
                <div class="widget about col-xs-12 col-sm-4 col-md-4">
                    <div class="footer-logo">
                        ...
                        <div class="section-heading">
                            <span class="h-text">Liên hệ</span>
                        </div>

                        <div class="fb-page"
                            data-href="https://www.facebook.com/Phim-m%E1%BB%9Bi-m%E1%BB%97i-ng%C3%A0y-107771938626773"
                            data-tabs="timeline" data-width="500" data-height="70" data-small-header="false"
                            data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
                            <blockquote
                                cite="https://www.facebook.com/Phim-m%E1%BB%9Bi-m%E1%BB%97i-ng%C3%A0y-107771938626773"
                                class="fb-xfbml-parse-ignore"><a
                                    href="https://www.facebook.com/Phim-m%E1%BB%9Bi-m%E1%BB%97i-ng%C3%A0y-107771938626773">Phim
                                    mới mỗi ngày</a></blockquote>
                        </div>
                    </div>
    ...
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v14.0"
        nonce="5nUDPJmY"></script>
    {{-- End fanpages --}}

    {{-- Comment Facebook --}}
    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v14.0"
        nonce="Jmf3hR7y"></script>

    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v14.0"
        nonce="uR4hhded"></script>
                        ...
                        $.each(data, function(key, value) {
                            if (value.title.search(expression) != -1 || value.description
                                ...
                                $('#result').append(
                                    ...
                                    value.image +
                                    '" width="100" class="" /><div style="flex-direction: column; margin-left: 4px;"><h5 style="text-align: center;" width="100%">' +
                                    value.title +
                                    '</h5><span style="display: -webkit-box; max-height: 8.2rem; -webkit-box-orient: vertical; overflow: hidden; text-overflow: ellipsis; white-space: normal; -webkit-line-clamp: 5; line-height: 1.6rem;" class="text-muted">| ' +
                                    value.description + '</span></div> </li><hr> '
                                )
                            }
                        })
                    })
    ...
    {{-- <script type="text/javascript">
        $(document).ready(function() {
            $.ajax({
                url: "{{ url('/filter_topview_default') }}",
                method: 'GET',
