    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h5 class="m-0 font-weight-bold text-primary"><a href="{{route('category.create')}}">Thêm danh mục</a></h5>
            </div>
            <div class="card-body">
                            ...
                            @foreach ($list as $key => $cate)
                                <tr id="{{ $cate->id }}">
                                    ...
                                    <td width="1px" >
                                        ...
                                        <button style="margin-left:3.5px " type="submit" name="" class="ui-button ui-widget ui-corner-all">
                                        ...
                                        <button style="margin-left:2.5px;margin-top:2px; "
                                            ...
                                            <a href="{{ route('category.edit', $cate->id) }}"class="ui-icon ui-icon-gear" >Sửa</a>
                                        </td>
                                        </button>
                                    </td>
