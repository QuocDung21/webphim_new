...
class MovieController extends Controller
{
    ...
    public function filter_default(Request $request)
    {
        ...
        foreach ($movie as $key => $mov) {
            ...
            <a href="chitiet.php" title="{{ $hot_sidebar->title }}">
                <div class="item-link">
                    <img src="https://png.pngtree.com/png-clipart/20220323/ourmid/pngtree-cartoon-summer-dwarf-girl-cute-png-image_4505142.png" class="lazy post-thumb"
                        alt="CHỊ MƯỜI BA: BA NGÀY SINH TỬ" title="{{ $hot_sidebar->title }}" />
                    <span class="is_trailer">
                        @if ($hot->phude == 0)
                            Phụ đề
                        @else
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('movie.index')->with('Thông báo thêm', 'Thêm thành công');;
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // return redirect()->route('movie.index')->with('Thông báo sửa', 'Sửa thành công');
